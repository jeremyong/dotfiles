...
myLogHook = fadeInactiveLogHook 0
...
--
myWorkspaces = ["1:term","2:web","3:code","4","5:media"] ++ map show [6..9]
...
xmobarTitleColor = "#256bd2"

-- Color of current workspace in xmobar.
xmobarCurrentWorkspaceColor = "#267bd2"
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_p),
     spawn "exe=`dmenu_run -nb '#002b36' -nf '#839496' -fn 'Source Code Pro for Powerline' -b | yeganesh` && eval \"exec $exe\"")
